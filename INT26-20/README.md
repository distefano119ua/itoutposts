...
По завданню необхідно створити та налаштувати роль та полісі для роботи з Amazon S3:
* Role: ec2-s3-dev-readonly
* Policy: доступ до dev-* buckets (GetObject, ListBucket)

1. Створюємо Policy (User guide: [link](https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_examples.html)):
```
AWS (IAM)
...
Є два варіанти (виконувати вже на самому EC2):
    * як профіки (User Data): виконати Advanced details із `EC2 запуск` і далі запустити файл на виконання
    * як новачок:
    ```
