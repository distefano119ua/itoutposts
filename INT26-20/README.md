...
Приклад:
Ви маєте веб-сервер на EC2, і домен example.com вказує на його IP. 
Без Elastic IP після перезапуску EC2 IP-address може змінитися, і сайт перестане відкриватися за старим DNS-записом. 
З Elastic IP адрес залишається тим самим.

Інструкція налаштування Elastic IP addresses: [youtube](https://www.youtube.com/watch?v=4T6fk6UtpsE)
